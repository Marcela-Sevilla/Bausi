    ...
    if( $pricing_model == 'single_role' ){
        ...
        if( ($price_type_1_properties && $product_type == 'simple') ){
            ...
            if( isset( $price_type_1_properties_arr[0] ) ){
                ...
                $minimum_quantity = $price_type_1_properties_arr[1] ? $price_type_1_properties_arr[1] : '';
...
add_action('init', 'whols_insert_default_term', 12);
function whols_insert_default_term(){
